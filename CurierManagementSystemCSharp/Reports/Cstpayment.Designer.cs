namespace CurierManagementSystemCSharp.Reports
{
    partial class customerpayment
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Customer_paymentBindingSource = new System.Windows.Forms.BindingSource(this.components);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.Customer_paymentBindingSource)).BeginInit();
            ...
            reportDataSource1.Value = this.Customer_paymentBindingSource;
            reportDataSource2.Name = "add_business";
            reportDataSource2.Value = this.add_businessBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "CurierManagementSystemCSharp.cstpayments.rdlc";
            ...
            // 
            // Customer_paymentBindingSource
            // 
            this.Customer_paymentBindingSource.DataMember = "Customer_payment";
            this.Customer_paymentBindingSource.DataSource = this.customer_payement;
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)(this.Customer_paymentBindingSource)).EndInit();
        ...
        private System.Windows.Forms.BindingSource Customer_paymentBindingSource;
